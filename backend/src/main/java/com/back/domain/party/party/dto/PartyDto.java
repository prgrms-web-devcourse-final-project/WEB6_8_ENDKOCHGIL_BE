...
public class PartyDto {
    ...
    private Integer myProgressRate;
    ...
    public PartyDto(Party party, Mission mission, String myStatus, Integer myProgressRate) {
        this(party, mission);
        this.myStatus = myStatus;
        this.myProgressRate = myProgressRate;
    }
}