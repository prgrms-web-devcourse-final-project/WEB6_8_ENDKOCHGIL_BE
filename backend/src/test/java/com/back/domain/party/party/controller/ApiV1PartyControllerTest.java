...
class ApiV1PartyControllerTest {
    ...
    void getPartyList_success_integration() throws Exception {
        ...
        leaderMember1.setJoinedAt(LocalDateTime.now());
        ...
        leaderMember2.setJoinedAt(LocalDateTime.now());
        ...
        leaderPrivate.setJoinedAt(LocalDateTime.now());
        ...
        mockMvc.perform(get("/api/v1/parties"))
                ...
                .andExpect(jsonPath("$.content.content[0].createDate").exists())
                ...
                .andExpect(jsonPath("$.content.content[1].createDate").exists());
    }
